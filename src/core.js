...
function calculatePreparationTime(l){
  return 3 * l
}
...
function totalTimeSpent(l, m){
  return bakingTime() - remainingBakeTime(m) + calculatePreparationTime(l)
}
